...
if __name__ == '__main__':
    ...
    cmdline.add_argument('--graphite-host',
                         '-gh',
                         action='store',
                         help="Provide the name of the graphite host to which the data would be published to",
                         dest='graphite_host',
                         default="stage2lp48.qa.paypal.com"
                         )
    ...
    os.environ["GRAPHITEHOST"] = args.graphite_host;
    print "Setting graphite host to : " + os.environ["GRAPHITEHOST"]

    p = Parsible(args.input_file, args.parser,
                args.pid_file, args.debug,
                args.batch, args.batch_reload,
                args.auto_reload, args.stat_prefix);
    p.main()
