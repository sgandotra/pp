...
public class SamplingProfiler {
     ...
     */
    private static final String[] DEFAULT_EXCLUDED_PACKAGES = new String[] {
        //"java.", "sun.", "com.sun.", "javax.", "org.apache.",
        //"org.hibernate.", "oracle.", "org.postgresql.", "org.eclipse.", 
    };
    ...
    private final Map<SampledMethod, SampledMethod> data = Maps.newHashMap();
    ...
    /**
     * Constructor.
     * Excluded packages by default "java,sun,com.sun,javax,org.apache,
     * org.hibernate,oracle,org.postgresql,org.eclipse"
     */
    SamplingProfiler() {
        super();
    ...
    SamplingProfiler(List<String> excludedPackages, List<String> includedPackages) {
        super();
        Preconditions.checkArgument(excludedPackages != null || includedPackages != null);
